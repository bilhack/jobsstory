...
class AppStrings {
  ...
  static const String jobsAr = 'وظائف';
  static const String jobsHint = 'Browse openings and apply with your story in one tap.';
  static const String jobsHintAr = 'تصفّح الوظائف وقدّم بقصتك بضغطة.';
  static const String noOpenJobs = 'No open jobs right now';
  static const String noOpenJobsAr = 'لا توجد وظائف مفتوحة حالياً';
  static const String noOpenJobsHint = 'New openings from recruiters will show here.';
  static const String noOpenJobsHintAr = 'وظائف جديدة من مسؤولي التوظيف ستظهر هنا.';
  static const String postJob = 'Post a job';
  static const String postJobAr = 'نشر وظيفة';
  static const String myJobs = 'My jobs';
  static const String myJobsAr = 'وظائفي';
  static const String myJobsHint = 'Post openings and review who is interested.';
  static const String myJobsHintAr = 'انشر وظيفة وتابع المهتمين بها.';
  static const String jobTitleLabel = 'Job title';
  static const String jobTitleLabelAr = 'المسمى الوظيفي';
  static const String companyLabel = 'Company';
  static const String companyLabelAr = 'الشركة';
  static const String locationLabel = 'Location';
  static const String locationLabelAr = 'الموقع';
  static const String descriptionLabel = 'Description';
  static const String descriptionLabelAr = 'الوصف';
  static const String jobPosted = 'Job posted';
  static const String jobPostedAr = 'تم نشر الوظيفة';
  static const String fillJobFields = 'Please add a title and company.';
  static const String fillJobFieldsAr = 'أضف المسمى الوظيفي والشركة على الأقل.';
  static const String jobStatusOpen = 'Open';
  static const String jobStatusOpenAr = 'مفتوحة';
  static const String jobStatusClosed = 'Closed';
  static const String jobStatusClosedAr = 'مغلقة';
  static const String closeJob = 'Close job';
  static const String closeJobAr = 'إغلاق الوظيفة';
  static const String reopenJob = 'Reopen job';
  static const String reopenJobAr = 'إعادة فتح الوظيفة';
  static const String applicantsToJob = 'Interested in this job';
  static const String applicantsToJobAr = 'المهتمون بهذه الوظيفة';
  static const String noApplicants = 'No applications yet';
  static const String noApplicantsAr = 'لم يقدّم أحد بعد';
  static const String noApplicantsHint = 'Share the job to attract seekers.';
  ...
  static const String appliedSnackAr = 'تم إرسال طلبك بنجاح';
  static const String needStoryTitle = 'Create your story first';
  static const String needStoryTitleAr = 'أنشئ قصتك أولاً';
  static const String needStoryBodyEn = 'Your story is your resume — you need an approved story before applying.';
  static const String needStoryBodyAr = 'قصتك هي سيرتك الذاتية — تحتاج إلى قصة معتمدة قبل التقديم.';
  static const String goToStudio = 'Create story';
  static const String goToStudioAr = 'إنشاء قصة';
  static const String myApplications = 'My applications';
  static const String myApplicationsAr = 'تطبيقاتي';
  static const String noApplications = 'No applications yet';
  static const String noApplicationsAr = 'لا توجد تقديمات بعد';
  static const String noApplicationsHint = 'Browse jobs and apply with your story.';
  static const String noApplicationsHintAr = 'تصفّح الوظائف وقدّم بقصتك.';
  static const String statusPending = 'New';
  static const String statusPendingAr = 'جديد';
  static const String statusContacted = 'Contacted';
  static const String statusContactedAr = 'تم التواصل';
  static const String statusRejected = 'Rejected';
  static const String statusRejectedAr = 'مرفوض';
  static const String updateStatus = 'Update status';
  static const String updateStatusAr = 'تحديث الحالة';
  static const String saveCandidateShort = 'Save';
  static const String saveCandidateShortAr = 'حفظ';
  static const String privateNote = 'Private note';
  static const String privateNoteAr = 'ملاحظة خاصة';
  static const String addNote = 'Add a private note about this candidate.';
  static const String addNoteAr = 'أضف ملاحظة خاصة عن هذا المرشح.';
  static const String saveNote = 'Save note';
  static const String saveNoteAr = 'حفظ الملاحظة';
  static const String copyEmail = 'Copy email';
  static const String copyEmailAr = 'نسخ البريد';
  static const String openMailApp = 'Open email app';
  static const String openMailAppAr = 'فتح تطبيق البريد';
  static const String emailCopied = 'Email copied';
  static const String emailCopiedAr = 'تم نسخ البريد';
}